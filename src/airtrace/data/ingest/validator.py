...
class FlightValidator:
    ...
    def __init__(
        ...
        self.sample_rows = self._normalize_sample_rows(sample_rows)
        self.report = ValidationReport()

    @classmethod
    def _normalize_sample_rows(cls, sample_rows: Optional[int]) -> int:
        """Coerce sample row input to a non-negative integer defaulting to the class constant."""

        if sample_rows is None:
            return cls.DEFAULT_SAMPLE_ROWS
